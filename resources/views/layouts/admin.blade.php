        ...
        <aside class="hidden md:flex md:w-64 md:flex-col md:fixed md:inset-y-0 bg-white border-r border-gray-200">
            <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
                ...
                <div class="flex items-center flex-shrink-0 px-6 gap-2">
                    <span class="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center text-white font-black text-lg shadow-md shadow-orange-500/20">S</span>
                    <span class="text-xl font-bold tracking-tight text-gray-900">
                        Sessi<span class="text-orange-500">admin</span>
                    </span>
                </div>
        ...
        <div x-show="mobileSidebarOpen" class="relative z-50 md:hidden" x-description="Off-canvas menu for mobile" role="dialog" aria-modal="true" style="display: none;">
            ...
            <div class="fixed inset-0 flex z-40">
                <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white pt-5 pb-4">
                    ...
                    <div class="flex items-center flex-shrink-0 px-6 gap-2">
                        <span class="w-8 h-8 rounded-lg bg-orange-500 flex items-center justify-center text-white font-black text-lg">S</span>
                        <span class="text-xl font-bold tracking-tight text-gray-900">Sessiadmin</span>
                    </div>
        ...
        <div class="flex-1 md:pl-64 flex flex-col min-h-screen">
            ...
            <header class="flex items-center justify-between md:hidden bg-white border-b border-gray-200 px-4 py-3">
                ...
                <div class="flex items-center gap-2">
                    <span class="w-7 h-7 rounded-lg bg-orange-500 flex items-center justify-center text-white font-black text-sm">S</span>
                    <span class="font-bold tracking-tight text-gray-900">Sessiadmin</span>
                </div>
