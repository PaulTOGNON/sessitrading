<x-store-layout>
    ...
    <!-- HERO CAROUSEL BANNER (ALPINE.JS DRIVEN) -->
        ...
        <div class="relative rounded-3xl overflow-hidden bg-gradient-to-r from-orange-400 to-amber-500 shadow-xl min-h-[220px] md:min-h-[380px] flex items-center">
                ...
                <div class="hidden md:flex relative h-64 lg:h-80 items-center justify-center">
                    ...
                    <div class="grid grid-cols-2 gap-4 max-w-sm w-full relative z-10">
                        <div class="bg-white/15 backdrop-blur-md p-3 rounded-2xl border border-white/10 flex flex-col items-center hover:scale-105 transition-transform duration-300">
                            <span class="text-[9px] uppercase font-bold text-orange-200">Baskets</span>
                            <img src="/images/products/product11.jpeg" class="w-20 h-20 object-cover rounded-xl mt-1.5 shadow" alt="sneaker">
                        </div>
                        <div class="bg-white/15 backdrop-blur-md p-3 rounded-2xl border border-white/10 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <div x-show="activeSlide === 1" class="w-full grid grid-cols-1 md:grid-cols-2 items-center p-6 md:p-12 gap-6 bg-gradient-to-r from-orange-500 to-red-500">
                <div class="flex flex-col gap-2 md:gap-4 text-white z-10">
                    ...
                    <a href="#all-products" class="mt-2 bg-white text-orange-600 hover:bg-orange-50 transition-colors w-max text-xs md:text-sm font-bold px-6 py-3 rounded-full shadow-lg shadow-white/10">
                        Voir la sélection
                    </a>
                </div>
    ...
    <section id="categories" class="max-w-7xl mx-auto px-4 lg:px-8 py-8 md:py-16">
        ...
        <div class="flex items-center gap-6 overflow-x-auto pb-4 scrollbar-none snap-x snap-mandatory">
            ...
            <!-- Category Item 3 (Chaussures) -->
            <a href="{{ route('store.shop') }}?category=Chaussures" class="flex flex-col items-center gap-3 flex-shrink-0 snap-start text-center w-24 md:w-32 group">
                <div class="w-20 h-20 md:w-28 md:h-28 rounded-full overflow-hidden border-2 border-transparent group-hover:border-orange-500 transition-all duration-300 bg-white dark:bg-gray-900 shadow-md">
                    <img src="https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=150&auto=format&fit=crop&q=80" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Chaussures">
                </div>
                <span class="text-xs md:text-sm font-bold text-gray-800 dark:text-gray-200 group-hover:text-orange-500 transition-colors truncate w-full">Chaussures</span>
            </a>

            <!-- Category Item 4 (Baskets) -->
            <a href="{{ route('store.shop') }}?category=Baskets" class="flex flex-col items-center gap-3 flex-shrink-0 snap-start text-center w-24 md:w-32 group">
                <div class="w-20 h-20 md:w-28 md:h-28 rounded-full overflow-hidden border-2 border-transparent group-hover:border-orange-500 transition-all duration-300 bg-white dark:bg-gray-900 shadow-md">
                    <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=150&auto=format&fit=crop&q=80" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" alt="Baskets">
                </div>
                <span class="text-xs md:text-sm font-bold text-gray-800 dark:text-gray-200 group-hover:text-orange-500 transition-colors truncate w-full">Baskets & Sneakers</span>
            </a>
    ...
    <!-- FEATURED BRAND CARD (Cran brand layout - Screenshot 2) -->
    <section class="max-w-7xl mx-auto px-4 lg:px-8 py-4 md:py-8">
        <div class="bg-gray-100 dark:bg-gray-900 rounded-3xl overflow-hidden shadow-lg border border-gray-100/50 dark:border-gray-800/50 grid grid-cols-1 md:grid-cols-2 items-center">
            ...
            <div class="relative h-64 md:h-96 bg-gray-200">
                <img src="https://images.unsplash.com/photo-1486308512493-ae6a1d9540c1?w=600&auto=format&fit=crop&q=80" class="w-full h-full object-cover" alt="CRAN Product Showcase">
            ...
            <div class="p-6 md:p-12 flex flex-col gap-4">
                <div class="flex items-center justify-between">
                    <!-- Brand logo placeholder styling -->
                    <div class="flex items-center gap-3">
                        <div class="bg-black text-white px-3 py-2 rounded font-black text-xs tracking-widest uppercase">CRAN SHOES</div>
                        <span class="text-xs font-bold text-gray-500 dark:text-gray-400">Marque Partenaire</span>
                    </div>
                ...
                <h3 class="text-2xl font-black text-gray-950 dark:text-white leading-tight">
                    Cran
                </h3>
                <p class="text-xs md:text-sm text-gray-500 dark:text-gray-400 leading-relaxed">
                    Découvrez notre nouvelle gamme de chaussures fermées haut de gamme. Cuir de première qualité, confort orthopédique et design élégant pour toutes vos tenues professionnelles et formelles.
                </p>

                <div class="flex items-center gap-4 mt-2">
                    <a href="{{ route('store.shop') }}?category=Chaussures" class="bg-orange-500 hover:bg-orange-600 text-white font-bold text-xs px-6 py-3 rounded-full shadow-lg shadow-orange-500/15">
    ...
    <!-- BRANDS LIST (Zara, Mango, Shein, Nike - Screenshot 2) -->
    <section class="max-w-7xl mx-auto px-4 lg:px-8 py-8">
        <h2 class="text-xl md:text-2xl font-black text-gray-950 dark:text-white tracking-tight mb-6 text-center md:text-left">
            Marques
        </h2>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <!-- Zara Card -->
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl h-24 flex flex-col items-center justify-center p-4 hover:scale-[1.02] hover:border-orange-500 hover:shadow-lg transition-all duration-300">
                <span class="text-gray-955 dark:text-white font-black text-lg tracking-widest">ZARA</span>
            </div>

            <!-- Mango Card -->
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl h-24 flex flex-col items-center justify-center p-4 hover:scale-[1.02] hover:border-orange-500 hover:shadow-lg transition-all duration-300">
                <span class="text-gray-955 dark:text-white font-serif text-lg tracking-wider font-semibold">MANGO</span>
            </div>

            <!-- Shein Card -->
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl h-24 flex flex-col items-center justify-center p-4 hover:scale-[1.02] hover:border-orange-500 hover:shadow-lg transition-all duration-300">
                <span class="text-gray-955 dark:text-white font-sans text-lg tracking-widest font-black uppercase">SHEIN</span>
            </div>

            <!-- Nike Card -->
            <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-855 rounded-2xl h-24 flex flex-col items-center justify-center p-4 hover:scale-[1.02] hover:border-orange-500 hover:shadow-lg transition-all duration-300">
                <span class="text-gray-955 dark:text-white font-sans text-xl italic font-black uppercase tracking-tight">NIKE</span>
            </div>
